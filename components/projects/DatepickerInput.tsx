...
export const DatepickerInput = ( {datepickerName, date = null, setDate, minDate = null, disable = false }: Props ) => {
      ...
      <div className="relative">
        {
          disable 
          ? (
            <span className="flex flex-row text-sm items-center border-gray-300 bg-gray-50 border outline-gray-400 text-gray-900 rounded-sm p-2.5 max-w-fit" >
              <span className="mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-black">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                </svg>
