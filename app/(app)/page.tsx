      ...
      <div className="flex flex-col max-w-screen-lg grow space-y-4"> 
        {
          menus.map(({name, description, url, icon}) => (
            <Link href={url} className="flex flex-row border-2 bg-gray-100 items-center border-gray-500 px-4 rounded-sm hover:cursor-pointer hover:bg-gray-200 hover:border-gray-600 transition-all duration-75">
              <div className="flex h-full items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.5} stroke="currentColor" className="text-gray-700 w-32 h-32">
                  {icon}
                </svg>
              </div>
